...
public class UsuarioService {
	...
	public Object insert(Request request, Response response) {
	    ...
	    int Quantidade_Criticas = Integer.parseInt(request.queryParams("Quantidade_Criticas"));

	    String resp = "";

	    Usuario usuario = new Usuario(ID_Usuario, Nome, Email, Senha, Generos, Data_Nascimento, Data_Ingresso, Quantidade_Criticas);
